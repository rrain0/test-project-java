...
import static calculation3.level2.Number.*;
...
/*
допустимые наборы аргументов функции: 1 или 0 аргументов до функции и хоть сколько после
 */
...
public class Function {
    ...
    public Function(/*@NonNull*/ String name, int priority, int preArgs, int postArgs, F func) {
        ...
        this.preArgs = preArgs; //0 или 1
        this.postArgs = postArgs; //0+
        this.func = func;
    }
